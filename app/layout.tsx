...
const navItems = [["/", "Home"], ["/services", "Systems"], ["/maintenance-plans", "Maintenance"], ["/industries", "Industries"], ["/legacy-evaluation", "Legacy Evaluation"], ["/about", "About"], ["/contact", "Contact"]];

export const metadata: Metadata = {
  metadataBase: new URL("https://sentinelpropertysystems.com"),
  title: { default: "Sentinel Property Systems | Operational Visibility for Modern Properties", template: "%s | Sentinel Property Systems" },
  description: "Sentinel Property Systems installs, documents, standardizes, and maintains managed smart property infrastructure for operational visibility across Northeast Florida properties.",
  keywords: ["smart property systems", "operational visibility", "property technology maintenance", "PoE camera installation", "security camera maintenance", "Wi-Fi infrastructure", "access control systems", "smart property infrastructure", "property visibility systems", "managed property systems", "jobsite visibility systems", "Jacksonville security systems", "Northeast Florida property technology"],
  openGraph: { title: "Sentinel Property Systems", description: "Operational Visibility for Modern Properties", url: "https://sentinelpropertysystems.com", siteName: "Sentinel Property Systems", locale: "en_US", type: "website" }
};
