...
export const metadata: Metadata = {
  ...
  keywords: ["security camera maintenance", "smart home security installer", "business security systems", "property technology maintenance", "camera troubleshooting", "access control installation", "smart lock installer", "jobsite security cameras", "Wi-Fi camera support", "commercial security maintenance", "security system repair", "Jacksonville security camera installer", "Northeast Florida smart security"],
  openGraph: { title: "Sentinel Property Systems", description: "Smart Security & Property Technology Maintenance", url: "https://sentinelpropertysystems.com", siteName: "Sentinel Property Systems", locale: "en_US", type: "website" }
};
