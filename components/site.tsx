...
export function PageHero({ eyebrow, title, copy, cta = "Schedule a Property Tech Consultation" }: { eyebrow: string; title: string; copy: string; cta?: string }) {
